 ...
 * MUI…) — identical to the React/Preact adapters' copy since the recipe
 * functions only touch the framework-agnostic field handle, never a
 * framework-specific API. See `docs/guides/headless-recipes.md`.
 *
 * The three contracts:
