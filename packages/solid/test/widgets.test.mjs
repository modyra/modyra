...
import { createSolidForm, field, required } from "../dist/index.js";
import { useMdySelect, useMdyField, executeSolidCommands } from "../dist/index.js";
...
test("widget entrypoints expose expected symbols", () => {
  ...
  assert.equal(typeof executeSolidCommands, "function");
});

runCommandExecutionTests(test, assert, executeSolidCommands, tick);
