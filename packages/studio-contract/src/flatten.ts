/**
 * Flattens a compiled Contract envelope (compileToContract's own output — v2 or v3)
 ...
 */
import { parseDynamicForm, type MdyDynamicField } from "@modyra/core";
import type { StudioContract } from "./compile.js";
...
export function flattenContractFields(contract: StudioContract): readonly MdyDynamicField[] {
