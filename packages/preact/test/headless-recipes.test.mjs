 ...
 * MUI…) — identical to the React adapter's copy since the recipe functions
 * only touch the framework-agnostic field handle, never Preact/React APIs.
 * See `docs/guides/headless-recipes.md`.
 *
 * The three contracts:
