 ...
 * vanilla-backed useMdyForm() (vanilla's tracking is module-global, so two
 * instances happen to share it), but silently inert for a handle owned by
 * any other runtime (Vue/Solid/Angular, or — as here — a custom one).
 */
