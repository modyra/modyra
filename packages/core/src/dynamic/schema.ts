...
export interface MdyDynamicValidators {
   ...
   *
   * Declared as the rule rather than as the `step: 1` it implies: `step` is what the rule does to
   * the native control, and a document says what it wants, not what that costs the control.
   */
