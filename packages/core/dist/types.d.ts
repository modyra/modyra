...
export type ValidatorFn<TValue = unknown> = (value: TValue) => readonly string[];
/**
 ...
 */
export type MdyAsyncValidatorFn<TValue = unknown> = (value: TValue) => Promise<readonly string[]>;
 ...
 */
export type MdyFormValidatorFn<TValue = Record<string, unknown>> = (value: TValue) => ReadonlyArray<MdyFormError>;
