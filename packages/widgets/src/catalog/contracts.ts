...
export const MDY_WIDGET_CONTRACTS = Object.freeze({
  ...
  multiselect: define("multiselect", ["mdy-renderer", "mdy-renderer--multiselect"], ["root", "label", "requiredMarker", "inputWrapper", "box", "chips", "chipRow", "chip", "chipMove", "chipStep", "chipLabel", "chipCount", "chipRemove", "trigger", "placeholder", "overflowCount", "wayBackAction", "clearAll", "arrow", "announcement", "chipTooltip", "popup", "search", "options", "optionWrapper", "option", "optionCheck", "optionStep", "optionLabel", "optionCount", "loading", "empty", "inlineError", "supportingText", "errors", "errorItem"] as const, true,
    { parents: { trigger: "box", arrow: "box", options: "popup", optionWrapper: "options", option: "optionWrapper", chips: "box", chipRow: "chips", chip: "chipRow", chipRemove: "chip", chipMove: "chip", chipLabel: "chip", chipCount: "chip", chipStep: "chip", chipTooltip: "box", placeholder: "trigger", overflowCount: "box", clearAll: "box", announcement: "box", wayBackAction: "box", search: "popup" },
      ...
      // `chipLabel` and `chipCount` are not in `required`, and the reason is a rule with its own
      // guard: a part is excused only where its parent is *declared* absent, never where the parent
      // merely is not in the DOM — otherwise a renderer could drop a subtree and be agreed with. A
      // multiselect at rest has no chips, so a required part inside one would be owed with nowhere
      // to be. What they have instead is a presence condition: they are there exactly when a chip is.
  ...
  datepicker: define("datepicker", ["mdy-renderer", "mdy-renderer--datepicker"], ["root", "label", "requiredMarker", "inputWrapper", "control", "toggle", "popup", "dialogHeader", "calendar", "grid", "weekdays", "weekday", "row", "gridcell", "monthPicker", "monthCell", "yearPicker", "yearCell", "inlineError", "supportingText", "errors", "errorItem"] as const, true,
    { classes: { control: ["mdy-datepicker__input", "mdy-datepicker__input--single"], toggle: ["mdy-datepicker__toggle", "mdy-datepicker__toggle--single"], popup: ["mdy-datepicker__popup", MDY_POPUP_CLASS, MDY_POPUP_SURFACE_CLASS], calendar: ["mdy-datepicker__calendar"], dialogHeader: ["mdy-datepicker__header"], grid: ["mdy-datepicker__grid", "mdy-datepicker__grid--single"], weekdays: ["mdy-datepicker__weekdays"], weekday: ["mdy-datepicker__weekday"], row: ["mdy-datepicker__row"], gridcell: ["mdy-datepicker__cell"], monthPicker: ["mdy-datepicker__month-picker"], monthCell: ["mdy-datepicker__month-cell"], yearPicker: ["mdy-datepicker__year-picker"], yearCell: ["mdy-datepicker__year-cell"] },
  ...
  daterange: define("daterange", ["mdy-renderer", "mdy-renderer--datepicker", "mdy-renderer--daterange"], ["root", "label", "requiredMarker", "inputWrapper", "startControl", "separator", "endControl", "toggle", "popup", "dialogHeader", "calendar", "grid", "weekdays", "weekday", "row", "gridcell", "monthPicker", "monthCell", "yearPicker", "yearCell", "inlineError", "supportingText", "errors", "errorItem"] as const, true,
    { classes: { startControl: ["mdy-datepicker__input", "mdy-daterange__input", "mdy-daterange__input--start"], endControl: ["mdy-datepicker__input", "mdy-daterange__input", "mdy-daterange__input--end"], separator: ["mdy-daterange__sep"], toggle: ["mdy-datepicker__toggle", "mdy-datepicker__toggle--range"], popup: ["mdy-datepicker__popup", MDY_POPUP_CLASS, MDY_POPUP_SURFACE_CLASS, "mdy-datepicker__popup--range"], calendar: ["mdy-datepicker__calendar"], dialogHeader: ["mdy-datepicker__header"], grid: ["mdy-datepicker__grid", "mdy-datepicker__grid--range"], weekdays: ["mdy-datepicker__weekdays"], weekday: ["mdy-datepicker__weekday"], row: ["mdy-datepicker__row"], gridcell: ["mdy-datepicker__cell"], monthPicker: ["mdy-datepicker__month-picker"], monthCell: ["mdy-datepicker__month-cell"], yearPicker: ["mdy-datepicker__year-picker"], yearCell: ["mdy-datepicker__year-cell"] },
      // The calendar is the `dialog` — not the popup around it. Two renderers write the role on the
      // calendar and one wrote it nowhere, while the catalogue said nothing at all, so a role two
      // adapters agree on was one nothing could check and the third had to guess at. It is the
      // calendar because that is the thing a person enters, works in and leaves; the popup is the
