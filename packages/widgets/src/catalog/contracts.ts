...
export const MDY_WIDGET_CONTRACTS = Object.freeze({
  ...
  multiselect: define("multiselect", ["mdy-renderer", "mdy-renderer--multiselect"], ["root", "label", "requiredMarker", "inputWrapper", "box", "chips", "chipRow", "chip", "chipMove", "chipLabel", "chipCount", "chipRemove", "trigger", "placeholder", "overflowCount", "wayBackAction", "clearAll", "arrow", "announcement", "chipTooltip", "popup", "search", "options", "optionWrapper", "option", "optionCheck", "optionStep", "optionLabel", "optionCount", "loading", "empty", "inlineError", "supportingText", "errors", "errorItem"] as const, true,
    { parents: { trigger: "box", arrow: "box", options: "popup", optionWrapper: "options", option: "optionWrapper", chips: "box", chipRow: "chips", chip: "chipRow", chipRemove: "chip", chipMove: "chip", chipLabel: "chip", chipCount: "chip", chipTooltip: "box", placeholder: "trigger", overflowCount: "box", clearAll: "box", announcement: "box", wayBackAction: "box", search: "popup" },
