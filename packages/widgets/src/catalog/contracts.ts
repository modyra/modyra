...
export const MDY_WIDGET_CONTRACTS = Object.freeze({
  ...
  multiselect: define("multiselect", ["mdy-renderer", "mdy-renderer--multiselect"], ["root", "label", "requiredMarker", "inputWrapper", "box", "trigger", "chips", "chip", "chipRemove", "chipMove", "placeholder", "clearAll", "arrow", "announcement", "wayBack", "wayBackAction", "popup", "search", "options", "optionWrapper", "option", "optionCheck", "optionStep", "optionLabel", "optionCount", "loading", "empty", "inlineError", "supportingText", "errors", "errorItem"] as const, true,
    { parents: { trigger: "inputWrapper", arrow: "trigger", options: "popup", optionWrapper: "options", option: "optionWrapper", chips: "trigger", chip: "chips", chipRemove: "chip", chipMove: "chip", placeholder: "trigger", clearAll: "inputWrapper", announcement: "inputWrapper", wayBack: "root", wayBackAction: "wayBack", search: "popup" },
      ...
      elements: { option: "presentation", options: "group", clearAll: "button", wayBackAction: "button" },
      ...
      roles: { options: "group", chip: "group", popup: "dialog" },
