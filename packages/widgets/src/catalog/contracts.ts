...
export const MDY_WIDGET_CONTRACTS = Object.freeze({
  ...
  multiselect: define("multiselect", ["mdy-renderer", "mdy-renderer--multiselect"], ["root", "label", "requiredMarker", "inputWrapper", "box", "trigger", "chips", "chip", "chipRemove", "chipMove", "chipTooltip", "placeholder", "overflowCount", "clearAll", "arrow", "announcement", "wayBack", "wayBackAction", "popup", "search", "options", "optionWrapper", "option", "optionCheck", "optionStep", "optionLabel", "optionCount", "loading", "empty", "inlineError", "supportingText", "errors", "errorItem"] as const, true,
