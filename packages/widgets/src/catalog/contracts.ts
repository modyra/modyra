...
export const MDY_WIDGET_CONTRACTS = Object.freeze({
  ...
  // decided to put it.
  timepicker: define("timepicker", ["mdy-renderer", "mdy-renderer--timepicker"], ["root", "label", "requiredMarker", "inputWrapper", "control", "toggle", "popup", "dialog", "container", "content", "header", "hour", "hourControl", "minute", "minuteControl", "period", "clock", "dialFace", "dialUnavailable", "dialUnavailableArc", "dialHand", "dialNumber", "modeToggle", "actions", "action", "inlineError", "supportingText", "errors", "errorItem"] as const, true,
    { parents: { dialog: "popup", header: "content", clock: "content", dialFace: "clock", dialHand: "dialFace", dialNumber: "dialFace", dialUnavailable: "dialFace", dialUnavailableArc: "dialUnavailable", content: "container", actions: "container", modeToggle: "actions", action: "actions", hourControl: "hour", minuteControl: "minute" },
