...
export const MDY_WIDGET_CONTRACTS = Object.freeze({
  ...
  multiselect: define("multiselect", ["mdy-renderer", "mdy-renderer--multiselect"], ["root", "label", "requiredMarker", "inputWrapper", "box", "chips", "chipRow", "chip", "chipMove", "chipRemove", "trigger", "placeholder", "overflowCount", "clearAll", "arrow", "announcement", "chipTooltip", "wayBack", "wayBackAction", "popup", "search", "options", "optionWrapper", "option", "optionCheck", "optionStep", "optionLabel", "optionCount", "loading", "empty", "inlineError", "supportingText", "errors", "errorItem"] as const, true,
    { parents: { trigger: "box", arrow: "trigger", options: "popup", optionWrapper: "options", option: "optionWrapper", chips: "box", chipRow: "chips", chip: "chipRow", chipRemove: "chip", chipMove: "chip", chipTooltip: "box", placeholder: "trigger", overflowCount: "box", clearAll: "box", announcement: "box", wayBack: "root", wayBackAction: "wayBack", search: "popup" },
