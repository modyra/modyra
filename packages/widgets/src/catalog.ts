...
export const MDY_WIDGET_CONTRACTS = Object.freeze({
  ...
  multiselect: define("multiselect", ["mdy-renderer", "mdy-renderer--multiselect"], ["root", "label", "requiredMarker", "inputWrapper", "trigger", "chips", "chip", "placeholder", "searchButton", "popup", "search", "listbox", "option", "optionCheck", "optionLabel", "optionCount", "optionStep", "loading", "empty", "inlineError", "supportingText", "errors", "errorItem"] as const, true,
    { classes: { trigger: ["mdy-multiselect"], placeholder: ["mdy-multiselect__placeholder"], chips: ["mdy-multiselect__chips"], chip: ["mdy-chip", "mdy-chip--value"], searchButton: ["mdy-multiselect__search-btn"], popup: ["mdy-multiselect__dropdown", MDY_POPUP_CLASS], search: ["mdy-multiselect-overlay__input"], listbox: ["mdy-multiselect__options"], option: ["mdy-chip"], optionCheck: ["mdy-chip__check"], optionLabel: ["mdy-chip__label"], optionCount: ["mdy-chip__count"], optionStep: ["mdy-chip__btn"], loading: ["mdy-select__loader"], empty: ["mdy-multiselect-overlay__empty"] } }),
  ...
  daterange: define("daterange", ["mdy-renderer", "mdy-renderer--datepicker", "mdy-renderer--daterange"], ["root", "label", "requiredMarker", "inputWrapper", "startControl", "separator", "endControl", "toggle", "popup", "calendar", "grid", "weekdays", "weekday", "row", "gridcell", "actions", "inlineError", "supportingText", "errors", "errorItem"] as const, true,
    { classes: { startControl: ["mdy-datepicker__input", "mdy-daterange__input"], endControl: ["mdy-datepicker__input", "mdy-daterange__input"], separator: ["mdy-daterange__sep"], toggle: ["mdy-datepicker__toggle"], popup: ["mdy-datepicker__popup", MDY_POPUP_CLASS], grid: ["mdy-datepicker__grid"], weekdays: ["mdy-datepicker__weekdays"], weekday: ["mdy-datepicker__weekday"], row: ["mdy-datepicker__row"], gridcell: ["mdy-datepicker__cell"], actions: ["mdy-datepicker__actions"] } }),
  timepicker: define("timepicker", ["mdy-renderer", "mdy-renderer--timepicker"], ["root", "label", "requiredMarker", "inputWrapper", "control", "toggle", "popup", "header", "hour", "minute", "period", "clock", "actions", "inlineError", "supportingText", "errors", "errorItem"] as const, true,
    { classes: { control: ["mdy-timepicker__input"], toggle: ["mdy-timepicker__toggle"], popup: ["mdy-timepicker__popup", MDY_POPUP_CLASS], header: ["mdy-timepicker-header"], hour: ["mdy-timepicker-segment"], minute: ["mdy-timepicker-segment"], period: ["mdy-timepicker-period-toggle"], clock: ["mdy-timepicker-dial"], actions: ["mdy-timepicker-actions"] } }),
