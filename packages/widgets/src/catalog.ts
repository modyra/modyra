...
export const MDY_WIDGET_CONTRACTS = Object.freeze({
  ...
  radio: define("radio", ["mdy-renderer", "mdy-renderer--radio-group"], ["root", "label", "requiredMarker", "group", "option", "optionControl", "optionLabel", "supportingText", "errors", "errorItem"] as const, false,
    { classes: { group: ["mdy-radio-group"], option: ["mdy-radio"], optionControl: ["mdy-radio__control"], optionLabel: ["mdy-radio__label"] } }),
  segmented: define("segmented", ["mdy-renderer", "mdy-renderer--segmented"], ["root", "label", "requiredMarker", "group", "option", "optionCheck", "optionText", "supportingText", "errors", "errorItem"] as const, false,
    { classes: { group: ["mdy-segmented"], option: ["mdy-segmented__button"], optionCheck: ["mdy-segmented__check"], optionText: ["mdy-segmented__label"] } }),
  select: define("select", ["mdy-renderer", "mdy-renderer--select"], ["root", "label", "requiredMarker", "inputWrapper", "trigger", "value", "arrow", "popup", "search", "listbox", "option", "loading", "empty", "inlineError", "supportingText", "errors", "errorItem"] as const, true,
    { classes: { trigger: ["mdy-select__trigger"], value: ["mdy-select__value"], arrow: ["mdy-select__arrow"], popup: ["mdy-select__dropdown"], search: ["mdy-select__search"], listbox: ["mdy-select__list"], option: ["mdy-select__option"], loading: ["mdy-select__loader"], empty: ["mdy-select__empty"] } }),
  multiselect: define("multiselect", ["mdy-renderer", "mdy-renderer--multiselect"], ["root", "label", "requiredMarker", "inputWrapper", "trigger", "chips", "chip", "searchButton", "popup", "search", "listbox", "option", "loading", "empty", "inlineError", "supportingText", "errors", "errorItem"] as const, true,
    { classes: { trigger: ["mdy-multiselect"], chips: ["mdy-multiselect__chips"], chip: ["mdy-chip"], searchButton: ["mdy-multiselect__search-btn"], popup: ["mdy-multiselect__dropdown"], search: ["mdy-multiselect-overlay__input"], listbox: ["mdy-multiselect__options"], option: ["mdy-multiselect__option"], loading: ["mdy-select__loader"], empty: ["mdy-multiselect-overlay__empty"] } }),
