...
export { canonicalWidgetSnapshot, compareToCanonical, MDY_CANONICAL_AT_REST, MDY_CANONICAL_DISABLED, MDY_CANONICAL_EMPTY, MDY_CANONICAL_INVALID, MDY_CANONICAL_OPEN } from "./canonical.js";
