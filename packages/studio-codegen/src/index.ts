...
export { isValidBindingName, isValidIdentifier, toBindingName, printArray, printCall, printKey, printObject, printRegExp, printString, type TsProp } from "./ts-print.js";
