...
const RENDERERS = [
  ...
  },
  {
    ...
    match: { testMatch: ["plain/**/*.spec.ts", "shared/**/*.spec.ts", "record-table/**/*.spec.ts", "conditional/**/*.spec.ts", "nested-orders/**/*.spec.ts", "nested-invoices/**/*.spec.ts", "nested-contracts/**/*.spec.ts"] },
  ...
  },
  {
    ...
    match: { testMatch: ["lit/**/*.spec.ts", "shared/**/*.spec.ts", "record-table/**/*.spec.ts", "conditional/**/*.spec.ts", "nested-orders/**/*.spec.ts", "nested-invoices/**/*.spec.ts", "nested-contracts/**/*.spec.ts"] },
    fullyParallel: true,
  },
] as const;
