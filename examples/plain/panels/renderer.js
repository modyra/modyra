  ...
  mount(work, readout) {
    ...
    const print = readoutPrinter(readout, () => ({
      ...
      clock: {
        ...
        // Which ring a press at a point falls on, and what the hour becomes when a person picks one.
        pressAtOneTwenty: timepickerDialRing({ width: 200, height: 200, left: 0, top: 0 }, 120, 100, "24h", 80),
        hourPicked: timeClockTransition("10:30", { type: "hour", value: 11, format: "24h" }),
      },
      // What a reader is told a strip holds — the value a gesture ended on, not every one it passed.
