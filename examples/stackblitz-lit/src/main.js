...
// applies to its markup directly. A second "control catalog" form below
// exercises every widget the UI package ships.
import "@modyra/styles/material.css";
import {
  createLitForm,
  crossField,
  email,
...
class SignupApp extends LitElement {
  form = createLitForm(
    ...
    },
    {
      ...
      draft: { key: "signup-stackblitz-lit", exclude: ["password", "confirm"] },
    },
  );
